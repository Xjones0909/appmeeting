...
import {
  ...
  Settings, LogOut, Users, BookOpen, ChevronRight, ClipboardCheck, DoorOpen
} from 'lucide-react'
...
export default function Sidebar({ role = 'user', pendingCount = 0 }: { role?: string; pendingCount?: number }) {
